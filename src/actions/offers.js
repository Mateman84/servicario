...
/*
    Since the data in the function extractDataFromOffer is an async/await. The data would not show up
    in the two functions below. The solution was to wrap the mapping of offers with Promise.all(). However
    I also had to make the .then into async and await my Promise.all()
*/
